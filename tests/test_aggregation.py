...
def test_build_analysis_table_dataset_level(analysis_config, synthetic_metafeatures) -> None:
    gap_table = pd.DataFrame(
        [
            [
                "dataset_a", 0, 0, "nn_vs_gbdt", "nn", "gbdt", "NN", "GBDT", "positive",
                "nn1", 0.2, 1.0, "gbdt1", 0.1, 0.0, 0.1, 1.0,
            ],
            [
                "dataset_a", 1, 0, "nn_vs_gbdt", "nn", "gbdt", "NN", "GBDT", "positive",
                "nn1", 0.1, 0.5, "gbdt1", 0.2, 0.75, -0.1, -0.25,
            ],
            [
                "dataset_b", 0, 0, "nn_vs_gbdt", "nn", "gbdt", "NN", "GBDT", "positive",
                "nn1", 0.3, 0.8, "gbdt1", 0.2, 0.2, 0.1, 0.6,
            ],
        ],
        columns=[
            "dataset",
